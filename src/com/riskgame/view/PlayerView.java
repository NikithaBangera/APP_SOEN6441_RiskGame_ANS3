...
public class PlayerView implements Observer {
	 ...
	 * 
	 * @param roundRobin - RoundRobin object
	 */
...
//			CardView cardView = new CardView(mapGraph, player);
		...
		listPlayerCountryList.addListSelectionListener(new ListSelectionListener() {
			...
			public void valueChanged(ListSelectionEvent e) {
				if (e.getValueIsAdjusting()) {
					...
					// Pending: Should reduce the army count on Player and add an army to the
					// country object.
				}
		...
		Iterator<Entry<String, Integer>> iterator = playerDomination.dominationPercentage(mapGraph).entrySet()
				.iterator();
	...
	/**
	 * This methos starts the initial reinforcement phase
	 * 
	...
	/**
	 * gets the selected adjacent country
	 * 
	 * @return - the country
	 */
	...
	/**
	 * Sets the selected adjacent country
	...
	/**
	 * gets the player's country details
	 * 
	 * @return - the details
	 */
	...
	/**
	 * Sets the player's country details
	 * @param playerCountryDetails - the details
	 */
	...
	/**
	 * gets the player's adjacent country details
	 * @return the adjacent country details
	 */
